...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/favicon.ico" rel="icon">
    ...
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/animate/animate.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/lightbox/css/lightbox.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/css/style.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="2" aria-label="Slide 3">
                    <img class="img-fluid" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/carousel-3.jpg" alt="Image">
                </button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/carousel-1.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/carousel-3.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">We Are Leader In</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Creative & Innovative Digital Solution</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-1.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-2.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-3.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-4.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-5.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/img/project-6.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
    ...
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/wow/wow.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/easing/easing.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/waypoints/waypoints.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/counterup/counterup.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/lib/lightbox/js/lightbox.min.js"></script>

    <!-- Template Javascript -->
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/new/js/main.js"></script>
</body>
