...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/bootstrap.css">
<!--Stylesheets-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/style.css">
<!--Responsive-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/responsive.css">
<!--Animation-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/animate.css">
<!--Prettyphoto-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/prettyPhoto.css">
<!--Font-Awesome-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/font-awesome.css">
<!--Owl-Slider-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/owl.theme.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/css/owl.transitions.css">
<!--[if lt IE 9]>
    ...
    <div class="container">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#menu"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Logo/01.png" alt=""></a> </div>
...
<section id="slider">
  <div id="home-carousel" class="carousel slide" data-ride="carousel">
    ...
    <!--
    <div class="item active" style="background-image:url(<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Slider/01.jpg)">
      ...
      <div class="item" style="background-image:url(<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Slider/02.jpg)">
        <div class="carousel-caption container">
          <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12">
              <h1>We Are Cosmix</h1>
      ...
      <div class="item" style="background-image:url(<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Slider/03.jpg)">
        <div class="carousel-caption container">
          <div class="row">
             <div class="col-md-7 col-sm-12 col-xs-12">
              <h1>We Are Cosmix</h1>
...
<section id="service">
  <div class="container">
    ...
    <div class="experience">
      ...
      <div class="col-sm-6  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Service/01.png" class="img-responsive" alt=""> </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane fade in active feat-sec" id="tab-1">
        ...
        <div class="col-md-6 tab-img"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Features/01.jpg" class="img-responsive" alt=""></div>
      </div>
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-2">
        ...
        <div class="col-md-6 tab-img"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Features/02.jpg" class="img-responsive" alt=""></div>
      </div>
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-3">
        ...
        <div class="col-md-6 tab-img"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Features/03.jpg" class="img-responsive" alt=""></div>
      </div>
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-4">
        ...
        <div class="col-md-6 tab-img"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Features/04.jpg" class="img-responsive" alt=""></div>
      </div>
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-5">
        ...
        <div class="col-md-6 tab-img"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Features/05.jpg" class="img-responsive" alt=""></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="portfolio-items">
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item creative">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/01.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/01.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-1</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item corporate portfolio">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/02.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/02.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-2</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
      ...
      <!--/.portfolio-item-->
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item creative">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/03.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/03.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-3</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item corporate">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/04.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/04.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-4</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item creative portfolio">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/05.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/05.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-5</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
      ...
      <!--/.portfolio-item-->
      <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item corporate">
        <div class="portfolio-item-inner"> <img class="img-responsive" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/06.jpg" alt="">
          <div class="portfolio-info"> <a class="preview" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Portfolio/06.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
            <h6>ITEM-6</h6>
            <p>Lorem Ipsum</p>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
        <div class="team-sec">
          <div class="team-img"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Team/01.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Julia Amanda</h5>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".2s">
        <div class="team-sec">
          <div class="team-img"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Team/02.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Merry Luis</h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".3s">
        <div class="team-sec">
          <div class="team-img"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Team/03.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Poll Astin</h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".4s">
        <div class="team-sec">
          <div class="team-img"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Team/04.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Janea Syria</h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
  ...
  <div class="container">
    ...
    <div class="slider-text">
      <div id="owl-testi" class="owl-carousel owl-theme">
        <div class="item">
          <div  class="col-md-10 col-md-offset-1"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Testimonials/02.jpg" class="img-circle" alt="">
        ...
        <div  class="col-md-10 col-md-offset-1"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Testimonials/03.jpg" class="img-circle" alt="">
        ...
        <div  class="col-md-10 col-md-offset-1"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Testimonials/04.jpg" class="img-circle" alt="">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Blog/1.jpg" class="img-responsive" alt="">
            <div class="data-meta">
              <h4>Jan</h4>
              <strong>10</strong><br>
              2016 </div>
        ...
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Blog/2.jpg" class="img-responsive" alt="">
            <div class="data-meta">
              <h4>Jan</h4>
              <strong>20</strong><br>
              2016 </div>
        ...
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/Blog/3.jpg" class="img-responsive" alt="">
            <div class="data-meta">
              <h4>Jan</h4>
              <strong>31</strong><br>
              2016 </div>
...
<div id="client">
  <div class="container">
    <div id="client-slider" class="owl-carousel">
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/1.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/2.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/3.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/4.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/5.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/6.png" class="img-responsive" alt=""/></a> </div>
      <div class="item client-logo"> <a href="#"><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/images/clients/7.png" class="img-responsive" alt=""/></a> </div>
    </div>
  </div>
</div>
...
<!--Jquery-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.min.js"></script>
<!--Boostrap-Jquery-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/bootstrap.js"></script>
<!--Preetyphoto-Jquery-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.prettyPhoto.js"></script>
<!--NiceScroll-Jquery-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.nicescroll.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/waypoints.min.js"></script>
<!--Isotopes-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.isotope.js"></script>
<!--Wow-Jquery-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/wow.js"></script>
<!--Count-Jquey-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.countTo.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/jquery.inview.min.js"></script>
<!--Owl-Crousels-Jqury-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/owl.carousel.js"></script>
<!--Main-Scripts-->
<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/extra/js/script.js"></script>
</body>
</html>
