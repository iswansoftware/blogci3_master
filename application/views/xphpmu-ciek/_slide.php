...
<?php
    ...
    if ($no==1){ $active = 'active'; }else{ $active = ''; }
        ...
        echo "<div class='item $active'>          
                <a class='hover-effect' href='".base_url()."berita/detail/$row[judul_seo]'><img style='width:100%; height:750px' src='".base_url()."asset/foto_berita/$foto_slide' alt='$row[judul]' class='img-responsive center-block'></a>
                <div style='text-align:left; top:190px; left:15px; right:10px; width:100%' class='carousel-caption wrapper container'>
                    ...
                    <a style='color:#fff' href='".base_url()."berita/detail/$row[judul_seo]'><h4 style='margin-top:400px !Important'>$row[judul]</h4></a>
                </div>
            </div>"; 
        $no++;
    }
